...
import (
	...
	sendinviteuseremailconsumer "github.com/eliabe-portfolio/restaurant-app/internal/queues/consumers/send-reset-password-email"
	"github.com/rabbitmq/amqp091-go"
)

type Producer interface {
	Send(message sendinviteuseremailconsumer.SendPasswordResetEmailMessage) error
}
...
func (p *producer) Send(message sendinviteuseremailconsumer.SendPasswordResetEmailMessage) error {
